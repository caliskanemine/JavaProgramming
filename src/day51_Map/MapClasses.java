...
public class MapClasses {
    ...
    public static void main(String[] args) {
        ...
        hashMap.put(3, "Jack");
        hashMap.put(40, "Emma");
        hashMap.put(5, "Isabella"); //will be removed, because key(5) is duplicated
        hashMap.put(5, "Ahmet");
        hashMap.put(6, "Ahmet");
        hashMap.put(7, "Ahmet");
        hashMap.put(8, "Ahmet"); //value can be duplicated in map
        hashMap.put(null, "Cihad");
        hashMap.put(null, "Emre");
        hashMap.put(null, "Hulya");

        System.out.println("hashMap = " + hashMap);
       // System.out.println(hashMap.get()); provide the key, not the index number
        ...
        System.out.println("linkedHashMap = " + linkedHashMap); //doesnt accept duplicating, but accepts null
